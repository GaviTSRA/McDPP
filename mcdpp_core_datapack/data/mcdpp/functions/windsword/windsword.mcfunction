...
execute at @e[type=minecraft:armor_stand, tag=WindSwordArmorstand] unless entity @a[distance=..5] run fill ~-3 ~-3 ~-3 ~3 ~3 ~3 air replace glass
...
execute as @e[type=minecraft:armor_stand, tag=WindSwordArmorstand] at @e[type=minecraft:armor_stand, tag=WindSwordArmorstand] unless entity @a[distance=..6] unless block ~ ~ ~ glass unless block ~ ~-1 ~ glass run kill @s
...
execute at @e[type=minecraft:armor_stand, tag=WindSwordArmorstand] run fill ~1 ~-1 ~1 ~-1 ~-1 ~-1 glass replace air
